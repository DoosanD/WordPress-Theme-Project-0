                    ...
                    <div class="form-group">
                        ...
                        <select name="brand" class="form-control">
                            ...
                            <?php foreach ($brands as $brand) : ?>
                                <option <?php if (isset($_GET['brand']) && ($_GET['brand'] == $brand->slug)) : ?> selected <?php endif; ?> value="<?php echo $brand->slug; ?>"><?php echo $brand->name; ?></option>
                            <?php endforeach; ?>
                        ...
                        <div class="col-lg-6">
                            ...
                            <select name="price_above" class="form-control">
                                ...
                                <?php for ($i = 0; $i < 210000; $i += 10000) : ?>
                                    ...
                                    <option <?php if (isset($_GET['price_above']) && ($_GET['price_above'] == $i)) : ?> selected <?php endif; ?> value="<?php echo $i; ?>">
                        ...
                        <div class="col-lg-6">
                            ...
                            <select name="price_below" class="form-control">
                                ...
                                <?php for ($i = 0; $i < 210000; $i += 10000) : ?>
                                    ...
                                    <option <?php if (isset($_GET['price_below']) && ($_GET['price_below'] == $i)) : ?> selected <?php elseif ($i == 200000) : ?> selected <?php endif; ?> value="<?php echo $i; ?>">
                                        <?php echo '$' . number_format($i); ?>
                                    </option>
